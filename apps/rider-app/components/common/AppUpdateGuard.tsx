...
const PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=com.asoose.rider";
const APP_STORE_URL = "https://apps.apple.com/app/idYOUR_RIDER_APP_ID";
          ...
          <ThemedView style={styles.card}>
            ...
            <ThemedText style={styles.description}>
              {updateInfo.isMandatory 
                ? "This version is no longer supported. Please update to the latest version to continue using ASOOSE Rider."
