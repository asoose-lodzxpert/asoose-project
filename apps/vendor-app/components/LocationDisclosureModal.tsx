        ...
        <SafeAreaView style={{ flex: 1, justifyContent: "center" }}>
          <ThemedView style={[styles.card, { backgroundColor: card }]}>
            ...
            >
              ...
              >
                ASOOSE uses your store location to connect you with nearby
                customers, manage deliveries efficiently, and provide real-time
              ...
              <View style={styles.featureList}>
                <FeaturePoint
                  ...
                  description="Monitor rider location during order fulfillment"
                  color={primary}
                />
                <FeaturePoint
                  icon="map.fill"
                  title="Store Location Visibility"
                  description="Help customers find your store on the map"
                  color={primary}
                />
                <FeaturePoint
                  icon="ticket.fill"
                  title="Delivery Management"
                  description="Optimize delivery routes and coordination"
                  color={primary}
                />
                <FeaturePoint
                  icon="clock.fill"
                  title="Real-Time Updates"
                  description="Provide accurate delivery and pickup times"
                  color={primary}
                />
              </View>
              ...
              >
                ...
                >
                  Your store location is encrypted and used only for order
                  operations. Customer support can access phone location only
                  when you authorize. Manage permissions in Settings anytime.
                </ThemedText>
              </View>
              ...
              <View style={styles.termsContainer}>
                ...
                >
                  ...
                  fulfillment. You may revoke location permissions at any time
                  through Settings, though this may affect service
                  functionality.
                </ThemedText>
              </View>
            </ScrollView>
