      ...
      <main className="max-w-md w-full text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="space-y-4">
          ...
          <p className="text-zinc-400 text-sm font-medium leading-relaxed max-w-[280px] mx-auto">
            We&apos;re currently refining the platform. You will be redirected automatically once we are live.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-6 pt-4">
          ...
          >
            <RefreshCw size={14} className={isChecking ? 'animate-spin' : 'group-hover:rotate-180 transition-transform duration-500'} />
            Check Status
          </button>
