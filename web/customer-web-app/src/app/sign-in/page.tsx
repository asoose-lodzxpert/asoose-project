        ...
        <div className="space-y-4">
         ...
         <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href={"/forgot-password"} type="button" className="text-gray-900 dark:text-white font-medium hover:text-yellow-500 transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/sign-up" className="text-gray-900 dark:text-white font-bold hover:text-yellow-500 transition-colors">
              Sign up
            </Link>
          </p>
        </div>
