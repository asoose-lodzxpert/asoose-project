      ...
      <div className="space-y-3 mb-6">
        {PAYMENT_METHODS.map((method) => {
          ...
          return (
            ...
            >
              <div className={`p-2 rounded-full ${isSelected ? 'bg-yellow-500 text-black' : 'bg-gray-100 dark:bg-white/10'}`}>
      ...
      >
        {isProcessing ? (
          ...
          <>
            ...
            {selectedMethod ? `Pay with ${selectedMethod.label}` : 'Select Payment Method'}
