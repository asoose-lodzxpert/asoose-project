...
import { ShoppingBag, Car, Package, MapPin, Settings } from 'lucide-react';
...
export const ProfileTabs = ({ activeTab, onTabChange }: { activeTab: string, onTabChange: (id: ProfileTab) => void }) => (
