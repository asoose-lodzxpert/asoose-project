...
import { DeliveryCard } from "@/app/main/components/cart/DeliveryCard";
import { CartItem as CartItemComponent } from "@/app/main/components/cart/CartItem";
...
export default function Cartcontent() {
  ...
  const { items, decreaseItem, addItem, removeItem, clearCart } =
    useCartStore();
  ...
  useEffect(() => {
    ...
    fetchCartSummary();
  }, [items, hasHydrated]); // Re-fetch whenever the client-side cart changes or after hydration
      ...
      <div className="max-w-xl mx-auto px-4 mt-6 space-y-6">
        ...
        <section>
          <div className="flex justify-between items-end mb-3 px-1">
            ...
            <button className="text-xs font-bold text-yellow-600 dark:text-yellow-500 bg-yellow-100 dark:bg-yellow-500/10 px-2 py-1 rounded hover:opacity-80">
              Change
            </button>
          </div>
          <DeliveryCard />
