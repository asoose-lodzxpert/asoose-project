...
export default function DeliveryProgressUI({
  delivery,
  stage: propStage,
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Icon Circle */}
                  <div
                    className={`w-12 h-12 shrink-0 rounded-full flex items-center justify-center border-4 transition-all duration-500
                    ${
                      isActive
                  ...
                  <div className="md:text-center">
                    <p
                      className={`font-bold text-sm ${isActive ? "text-zinc-900 dark:text-white" : "text-zinc-400"}`}
                    >
                      {step.label}
                    </p>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-zinc-500 text-sm">
                      {getCityDisplay(delivery?.pickupAddress)}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-zinc-500 text-sm">
                      {getCityDisplay(delivery?.dropoffAddress)}
                    </p>
                  </div>
                </div>
              </div>
