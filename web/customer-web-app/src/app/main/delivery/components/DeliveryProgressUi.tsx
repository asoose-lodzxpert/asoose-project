    ...
    <div className="p-6 animate-in slide-in-from-bottom-5">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500">
              {courier?.vehicle || "Yamaha Bike • LAG-442"}
            </p>
          </div>
        </div>
      ...
      <div className="space-y-6 relative pl-6">
        ...
        <div className="flex items-center gap-4 relative">
          <div
            className={`w-5 h-5 rounded-full z-10 ${stage === "COURIER_ASSIGNED" ? "bg-yellow-500" : "bg-gray-300"}`}
          />
          <p className="text-sm font-bold dark:text-zinc-300">
            Courier moving to pickup
          </p>
        </div>
        <div className="flex items-center gap-4 relative">
          <div
            className={`w-5 h-5 rounded-full z-10 ${stage === "PICKED_UP" ? "bg-yellow-500" : "bg-gray-300"}`}
          />
          <p className="text-sm font-bold dark:text-zinc-300">
            Package collected
          </p>
