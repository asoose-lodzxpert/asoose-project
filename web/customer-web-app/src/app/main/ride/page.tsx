...
import { Package, ChevronRight, Box, Layers, Truck, Home, Briefcase } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white transition-colors duration-300">
      <main className="max-w-6xl mx-auto px-6 py-10 pb-32 md:pb-20">
        <header className="mb-10 text-center lg:text-left">
          <h1 className="text-3xl font-black tracking-tight">Send a Package</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-10">
            <section className="space-y-4">
              ...
              <div className="relative space-y-4">
                ...
                {/* Pickup Autocomplete */}
                <div className="relative z-[50] bg-gray-50 dark:bg-zinc-900/40 p-5 rounded-3xl border border-gray-100 dark:border-zinc-800/50 shadow-sm">
                ...
                <div className="relative z-[40] bg-gray-50 dark:bg-zinc-900/40 p-5 rounded-3xl border border-gray-100 dark:border-zinc-800/50 shadow-sm">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl text-xs font-bold hover:bg-gray-100 dark:hover:bg-zinc-700/50 transition-colors">
                      <Home size={14} className="text-yellow-500" /> Home
                    </button>
                    <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl text-xs font-bold hover:bg-gray-100 dark:hover:bg-zinc-700/50 transition-colors">
                      <Briefcase size={14} className="text-yellow-500" /> Work
                    </button>
                  </div>
                </div>
              </div>
            ...
            <section className="space-y-4">
              ...
              <textarea 
                className="w-full bg-gray-50 dark:bg-zinc-900/40 p-5 rounded-3xl border border-gray-100 dark:border-zinc-800/50 text-sm outline-none focus:ring-2 focus:ring-yellow-500/20 min-h-[120px] resize-none dark:placeholder-zinc-600"
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24">
                ...
                {packageSizes.map((size) => (
                  <button
                    ...
                    className={`p-4 rounded-3xl border-2 text-center transition-all flex flex-col items-center gap-3 ${
                      ...
                      : 'border-transparent bg-gray-50 dark:bg-zinc-900/40 hover:bg-gray-100 dark:hover:bg-zinc-800/50'
                    }`}
                  >
            ...
            <div className="p-6 bg-gray-50 dark:bg-zinc-900/40 border border-gray-100 dark:border-zinc-800 rounded-3xl space-y-4">
              <div className="flex justify-between items-center text-sm font-bold">
                <span className="text-gray-500 dark:text-zinc-500">Estimated Base Fare</span>
                <span className="text-lg">₦{selectedPackage.price.toLocaleString()}</span>
              </div>
              <div className="h-px bg-gray-200 dark:bg-zinc-800/50" />
              <button 
                onClick={() => setStage('SELECTING_VEHICLE')}
                disabled={!pickupPos || !dropoffPos}
                className="w-full bg-yellow-500 hover:bg-yellow-600 disabled:bg-gray-200 dark:disabled:bg-zinc-800 disabled:text-gray-400 dark:disabled:text-zinc-600 text-white font-black py-4 px-8 rounded-2xl transition-all shadow-xl shadow-yellow-500/10 dark:shadow-none flex items-center justify-center gap-2 active:scale-95"
              >
