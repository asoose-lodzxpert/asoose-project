...
export function MapView() {
  ...
  const routePath = useMemo(() => {
    ...
    return routePolyline ? window.google.maps.geometry.encoding.decodePath(routePolyline) : [];
  ...
  return isLoaded ? (
    ...
    >
      {pickupLocation && <Marker position={pickupLocation} label={{ text: "P", color: "white" }} />}
      {dropoffLocation && <Marker position={dropoffLocation} label={{ text: "D", color: "white" }} />}
