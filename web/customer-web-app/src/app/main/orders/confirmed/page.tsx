                ...
                <div className="w-full max-w-md space-y-6">
                  ...
                  <div className="pb-8 space-y-3">
                    {orderId && (
                      ...
                      >
                        <button className="w-full py-3 bg-yellow-500 text-black font-bold rounded-xl shadow-lg hover:bg-yellow-400 transition-colors">
                          View Order Details
                        </button>
                      </Link>
                    )}
                    <Link href="/main/store" className="block w-full">
                      <button className="w-full py-3 bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white font-bold rounded-xl shadow hover:bg-gray-200 dark:hover:bg-white/20 transition-colors">
                        Continue Shopping
                      </button>
                    </Link>
                  </div>
