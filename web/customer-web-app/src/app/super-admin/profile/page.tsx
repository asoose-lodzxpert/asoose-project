  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] gap-4">
        <div className="text-red-500 text-xl font-bold">Failed to load profile</div>
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      <header>
        ...
        <p className="text-gray-400 text-sm">Manage your administrative profile and security credentials.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
          <div className="bg-[#1E293B] border border-gray-800 rounded-3xl p-8 text-center relative overflow-hidden shadow-2xl">
            ...
            <p className="text-gray-500 text-[10px] font-black uppercase tracking-widest mb-6">{profile.email}</p>
            
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between px-4 py-3 bg-[#0F172A] rounded-2xl border border-gray-800">
                <span className="text-[10px] font-black text-gray-500 uppercase">Role</span>
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-[#0F172A] rounded-2xl border border-gray-800">
                <span className="text-[10px] font-black text-gray-500 uppercase">Member Since</span>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <section className="bg-[#1E293B] border border-gray-800 rounded-3xl overflow-hidden shadow-xl">
            <div className="p-6 border-b border-gray-800 flex items-center gap-3 bg-white/5">
              <div className="p-2 bg-blue-500/20 rounded-xl text-blue-400"><User size={18}/></div>
              <h3 className="font-black text-white text-sm">Personal Information</h3>
            </div>
            
            <form onSubmit={profileForm.handleSubmit(onUpdateProfile)} className="p-8 space-y-6">
          ...
          <section className="bg-[#1E293B] border border-gray-800 rounded-3xl overflow-hidden shadow-xl">
            <div className="p-6 border-b border-gray-800 flex items-center gap-3 bg-white/5">
              <div className="p-2 bg-red-500/20 rounded-xl text-red-400"><Lock size={18}/></div>
              <h3 className="font-black text-white text-sm">Security Credentials</h3>
            </div>

            <form onSubmit={passwordForm.handleSubmit(onUpdatePassword)} className="p-8 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
              ...
              <div className="flex justify-end">
                ...
                >
                  {isChangingPassword ? <Loader2 className="w-4 h-4 animate-spin" /> : <Key size={18} />}
