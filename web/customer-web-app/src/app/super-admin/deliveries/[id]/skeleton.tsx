    ...
    <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-6 pb-20 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
           ...
           <div className="bg-[#1E293B] border border-gray-800 rounded-xl overflow-hidden">
              ...
              <div className="bg-gray-900/50 p-5 border-t border-gray-800 space-y-3">
                  <div className="flex justify-between"><div className="h-3 w-20 bg-gray-800 rounded"></div><div className="h-3 w-16 bg-gray-800 rounded"></div></div>
                  <div className="flex justify-between pt-2 border-t border-gray-800"><div className="h-5 w-24 bg-gray-800 rounded"></div><div className="h-6 w-32 bg-gray-800 rounded"></div></div>
              </div>
           </div>
        ...
        <div className="lg:col-span-1 space-y-6">
           ...
           {/* Info Cards Skeleton */}
           {[1, 2, 3].map((card) => (
               <div key={card} className="bg-[#1E293B] border border-gray-800 rounded-xl p-5 space-y-4">
