  ...
  return (
    <div className="bg-[#1E293B] border border-gray-800 rounded-lg p-4 hover:border-gray-700 transition-colors">
      ...
      <div className="flex justify-between items-start mb-3 gap-2">
        ...
        <span
          className={`px-2 py-1 rounded text-xs font-bold uppercase border flex-shrink-0 ${getStatusColor(delivery.status)}`}
        >
          {delivery.status}
        </span>
      </div>
      ...
      <div className="space-y-2 mb-3 text-sm">
        ...
        <div className="flex justify-between gap-2">
          ...
          <span
            className={`truncate text-right ${delivery.driver === "-" ? "text-gray-600 italic" : "text-gray-300"}`}
          >
