...
const getStatusColor = (status: string) => {
  switch (status) {
    ...
    case 'Cancelled': case 'Failed': return 'bg-red-500/20 text-red-400 border-red-500/20';
...
export default function OrderCard({ 
  ...
  return (
    <div className={`bg-[#1E293B] border border-gray-800 rounded-lg p-4 hover:border-gray-700 transition-colors ${className}`}>
      {/* Header: ID + Status */}
