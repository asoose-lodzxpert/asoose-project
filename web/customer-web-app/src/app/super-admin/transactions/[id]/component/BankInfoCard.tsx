...
export const BankInfoCard = ({ info }: { info: NonNullable<TransactionDetail['bankInfo']> }) => {
  return (
    <SectionCard title="Bank Account" icon={Building2} iconColorClass="bg-green-500/20 text-green-500">
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <p className="text-white font-mono">**** {info.accountNumber.slice(-4)}</p>
