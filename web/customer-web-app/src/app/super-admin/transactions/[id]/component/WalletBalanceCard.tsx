    ...
    <SectionCard title="Wallet Balance" icon={DollarSign} iconColorClass="bg-emerald-500/20 text-emerald-500">
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <span className="text-white font-medium"><Currency amount={before} /></span>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-gray-400">Transaction</span>
          <span className={`font-bold flex items-center gap-1 ${isCredit ? 'text-green-500' : 'text-orange-500'}`}>
        ...
        <div className="pt-3 border-t border-gray-700">
          <div className="flex justify-between items-center">
            ...
            <span className="text-white font-bold text-lg"><Currency amount={after} /></span>
          </div>
        </div>
      </div>
    </SectionCard>
