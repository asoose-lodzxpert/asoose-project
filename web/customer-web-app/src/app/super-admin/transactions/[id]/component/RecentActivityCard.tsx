...
export const RecentActivityCard = ({
  ...
  activity: NonNullable<TransactionDetail["recentActivity"]>;
}) => {
  return (
    <SectionCard
      title="Recent Activity"
      icon={TrendingUp}
      iconColorClass="bg-cyan-500/20 text-cyan-500"
    >
      ...
      <div className="space-y-4">
        ...
        {(activity.totalRevenue !== undefined ||
          activity.totalEarnings !== undefined) && (
          <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 p-4 rounded-lg border border-green-500/20">
            ...
            <p className="text-green-500 font-bold text-2xl">
              $
              {(activity.totalRevenue || activity.totalEarnings || 0).toFixed(
                2,
              )}
            </p>
          </div>
