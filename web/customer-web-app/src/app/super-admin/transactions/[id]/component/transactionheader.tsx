  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          onClick={onShare}
          className="p-2 text-gray-400 hover:text-white bg-gray-800 rounded-lg border border-gray-700"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded-lg border border-gray-700 hover:bg-gray-700 font-medium text-sm"
        >
          {isDownloading ? (
            <Loader2 className="w-4 h-4 animate-spin" />
          ) : (
