...
import { CheckCircle, Info, AlertTriangle, Truck, Check, CreditCard, Car } from 'lucide-react';
...
export default function NotificationCard({ notification, onRead }: NotificationProps) {
    ...
    `}>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex justify-between items-start">
          <h4 className={`text-sm font-semibold mb-1 truncate ${notification.isRead ? 'text-gray-300' : 'text-white'}`}>
            {notification.title}
          </h4>
