...
const RevenueCard = ({
  ...
  <div
    ...
    onClick={onClick}
  >
    <p className="text-gray-400 text-xs font-bold uppercase mb-2 truncate">
      {title}
    </p>
    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
      <div className="flex items-center gap-3">
        {/* Icon Container */}
        <div
          className={`p-2 bg-${color}-500/10 rounded-lg text-${color}-500 shrink-0`}
        >
      ...
      {change !== undefined && (
        <div
          className={`flex items-center gap-1 text-sm font-bold ${change >= 0 ? "text-green-500" : "text-red-500"}`}
        >
          {change >= 0 ? (
