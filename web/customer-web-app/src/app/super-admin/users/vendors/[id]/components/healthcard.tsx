...
export default function HealthScoreCard({ totalOrders }: HealthScoreCardProps) {
  ...
  const healthColor =
    healthScore >= 90 ? "#22c55e" : healthScore >= 70 ? "#eab308" : "#ef4444";
  ...
  return (
    <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-6 relative overflow-hidden">
      <div className="flex justify-between items-start mb-4">
        ...
        <div
          className={`text-xs font-bold px-2 py-1 rounded ${healthScore >= 90 ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}
        >
