...
export const CustomerContentTabs: React.FC<CustomerContentTabsProps> = ({ 
  activeTab, setActiveTab, orders, rides, isLoading, customerName 
}) => {
        ...
        {activeTab === 'Rides' && (
           rides.length > 0 ? (
            <div className="divide-y divide-gray-800 animate-in fade-in duration-300">
              {rides.map(ride => (
                <div key={ride.id} className="p-4 flex justify-between items-center hover:bg-[#0F172A] transition-colors">
                  ...
                  <div className="text-right">
                     ...
                     <Currency amount={ride.totalFare} className="text-white text-sm" />
