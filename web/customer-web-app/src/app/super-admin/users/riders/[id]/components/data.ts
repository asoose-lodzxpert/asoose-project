...
export const mockRides: Ride[] = [
  { id: 'RID-501', date: '2024-05-10 14:30', from: 'Central Station', to: 'Airport Terminal 1', fare: '$45.00', status: 'Completed', customer: 'John D.', duration: '25 min' },
  // ... rest of your mock rides
];

export const mockPayouts: Payout[] = [
  { id: 'PAY-045', date: '2024-05-10', amount: '$450.50', status: 'Paid', method: 'Bank Transfer', description: 'Weekly Earnings', processedBy: 'Auto System' },
