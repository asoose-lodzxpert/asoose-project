    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
      ...
      <div className="lg:col-span-2 bg-red-900/10 border border-red-500/20 rounded-xl p-5 relative overflow-hidden">
         ...
         <div className="flex justify-between items-start mb-4">
            <div>
              <p className="text-red-400 text-xs font-bold uppercase tracking-wider mb-1">Requires Action</p>
         ...
         <div className="grid grid-cols-2 gap-4 border-t border-red-500/10 pt-4">
            ...
            <div>
               ...
               <p className="text-red-400 font-bold text-lg flex items-center gap-2">
                 {stats.breachedSLA} <AlertTriangle className="w-3 h-3 animate-pulse" />
               </p>
            </div>
         </div>
      </div>
      ...
      <div className="bg-[#1E293B] border border-gray-800 rounded-xl p-5">
         ...
         <p className="text-2xl font-bold text-white mb-2">{stats.totalResolved}</p>
         <div className="w-full bg-gray-700 h-1.5 rounded-full overflow-hidden">
            <div className="bg-green-500 h-full" style={{ width: `${stats.resolutionRate}%` }}></div>
         </div>
         <p className="text-xs text-gray-500 mt-2">{stats.resolutionRate.toFixed(0)}% Resolution Rate</p>
      </div>
