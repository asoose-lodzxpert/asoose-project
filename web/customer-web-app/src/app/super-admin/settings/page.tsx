...
const SETTING_DEFINITIONS: SystemSettingDef[] = [
  ...
  // ── Ride Pricing (Tiered Model) ──────────────────────────────────────────────
  {
    category: "Logistics",
    key: "ride_fare_5km",
    label: "Fare: 0-5km (₦)",
    type: "currency",
    description: "Total fare for rides between 0 and 5 kilometres",
    defaultValue: 5000,
  },
  {
    category: "Logistics",
    ...
    label: "Fare: 5-10km (₦)",
    type: "currency",
    description: "Total fare for rides between 5 and 10 kilometres",
    defaultValue: 8000,
  },
  {
    category: "Logistics",
    ...
    label: "Fare: 10-15km (₦)",
    type: "currency",
    description: "Total fare for rides between 10 and 15 kilometres",
    defaultValue: 12000,
  },
  {
    category: "Logistics",
    ...
    label: "Fare: 15-20km (₦)",
    type: "currency",
    description: "Total fare for rides between 15 and 20 kilometres",
    defaultValue: 15000,
  },
  {
    category: "Logistics",
    ...
    label: "Fare: 20-25km (₦)",
    type: "currency",
    description: "Total fare for rides between 20 and 25 kilometres",
    defaultValue: 18000,
  },
  {
    category: "Logistics",
    ...
    label: "Fare: 25-30km (₦)",
    type: "currency",
    description: "Total fare for rides between 25 and 30 kilometres",
    defaultValue: 21000,
  },
  {
    category: "Logistics",
    key: "ride_fare_extra_km",
    label: "Fare: Extra Per KM (>30km) (₦)",
    type: "currency",
    description: "Additional charge per km for rides exceeding 30 kilometres",
    defaultValue: 1000,
  },
  {
    category: "Logistics",
    key: "ride_night_surcharge_per_km",
    label: "Ride: Night Surcharge (₦/km)",
    type: "currency",
    description: "Added per km during night hours (10PM - 5AM)",
    defaultValue: 1000,
  },
  {
    category: "Logistics",
  ...
  },
  {
    ...
    type: "currency",
    description: "Charge per kilometre for deliveries",
    defaultValue: 400,
  },
  {
    category: "Logistics",
    key: "delivery_otp_required",
    label: "Enforce Delivery OTP",
    type: "toggle",
    description: "Require OTP verification to complete delivery",
    defaultValue: true,
  },
  {
    category: "Logistics",
    key: "delivery_max_weight",
    label: "Max Delivery Weight (kg)",
    type: "input",
    description: "Limit for standard delivery bikes",
    defaultValue: "25",
  },
  // ── Airport Pricing ──────────────────────────────────────────────────────────
  {
    category: "Logistics",
    key: "ride_airport_base_10km",
    label: "Airport: Base 0-10km (₦)",
    type: "currency",
    description: "Flat rate for airport drop-offs within 10 kilometres",
    defaultValue: 10000,
  },
  {
    category: "Logistics",
    key: "ride_airport_extra_km",
    label: "Airport: Extra Per KM (>10km) (₦)",
    type: "currency",
    description: "Additional charge per km for airport rides exceeding 10 kilometres",
    defaultValue: 2000,
  },
  // ── Surcharges & Fees ───────────────────────────────────────────────────────
  {
    ...
    type: "currency",
    description:
      "Extra per-km rate applied after 10 PM. This is added on top of the base tier.",
    defaultValue: 1000,
  },
  {
    category: "Logistics",
    key: "ride_business_multiplier",
    label: "Business Class Multiplier",
    type: "input",
    description: "Factor applied to economy fare for business class rides (e.g. 1.5)",
    defaultValue: "1.5",
  },
  {
    category: "Logistics",
    ...
    label: "Platform Fee (%)",
    type: "percentage",
    description: "Percentage of the total fare retained by the platform",
    defaultValue: 20,
  },
  // ── Delivery Pricing ─────────────────────────────────────────────────────────
  {
