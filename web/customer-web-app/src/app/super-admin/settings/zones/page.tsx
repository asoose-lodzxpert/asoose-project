    ...
    <div className="min-h-screen bg-[#0F172A] p-4 md:p-6 pb-20 flex flex-col h-screen">
      <div className="flex justify-between items-center mb-6 shrink-0">
        <div>
          ...
          <p className="text-gray-400 text-sm">Define geofenced areas for operations.</p>
        </div>
        ...
        <div className="w-full lg:w-1/3 flex flex-col gap-4 overflow-y-auto pr-2 custom-scrollbar">
          ...
          <div className="space-y-3 pb-10">
            {isLoading ? (
              ...
              zones?.map((zone) => (
                <div key={zone.id} className="bg-[#1E293B] border border-gray-800 p-4 rounded-xl flex justify-between items-center group hover:border-gray-600">
                  <div>
