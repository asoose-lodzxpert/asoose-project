        ...
        <div className="flex items-center gap-4 mb-6 lg:mb-8">
          ...
          <div>
            <h1 className="text-xl lg:text-3xl font-bold text-white flex items-center gap-3">
              ...
              <span
                className={`text-xs px-3 py-1 rounded-full border ${isVendor ? "border-blue-500/30 bg-blue-500/10 text-blue-400" : "border-orange-500/30 bg-orange-500/10 text-orange-400"}`}
              >
                {isVendor ? "VENDOR" : "RIDER"}
              </span>
            </h1>
            <p className="text-gray-400 text-sm mt-1">
              Reviewing credentials for{" "}
...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-3">
      <div className="p-2 bg-gray-800/50 rounded-lg shrink-0">{icon}</div>
            ...
            <div className="bg-[#1E293B] border border-gray-800 rounded-2xl p-6 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-4">
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="bg-[#0F172A] border border-gray-800 rounded-xl overflow-hidden"
                  >
                    <div className="p-3 border-b border-gray-800 flex justify-between items-center bg-gray-900/50">
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex flex-col items-center justify-center p-6 text-center">
      ...
      <p className="text-gray-400 mb-6 max-w-md">
        The verification request you are looking for may have been deleted or
        already processed.
      </p>
      <button
        onClick={onRetry}
