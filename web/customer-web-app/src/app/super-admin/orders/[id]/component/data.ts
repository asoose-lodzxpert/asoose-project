...
export const MOCK_ORDER_DETAIL: OrderDetail = {
  ...
  payment: {
    ...
    serviceFee: 1.5,
    tax: 2.0,
    total: 28.5, // Note: Total usually sum of above, kept as per original mock
  },
  timeline: [
    {
      title: "Order Placed",
      date: "2024-05-10 14:00:00",
      desc: "by Customer John Doe",
      done: true,
    },
    {
      title: "Accepted by Vendor",
      date: "2024-05-10 14:02:15",
      desc: "Joe's Pizza",
      done: true,
    },
    {
    ...
    },
    {
      ...
      date: "2024-05-10 14:20:00",
      desc: "",
      done: true,
    },
    {
      title: "Rider Assigned",
      date: "2024-05-10 14:22:00",
      desc: "Sarah J. (RDR-005)",
      done: true,
    },
    {
  ...
  logs: [
    {
      date: "2024-05-10 12:46:00",
      user: "Super Admin",
      action: "Order status changed from 'Pending' to 'Processing' manually.",
    },
    {
      date: "2024-05-10 14:02:00",
      user: "Support Admin",
      action: "Contacted vendor for order confirmation.",
    },
  ],
};
