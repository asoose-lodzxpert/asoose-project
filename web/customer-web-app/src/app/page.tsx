...
export default function AsooseLanding() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main
        className={`flex-grow selection:bg-yellow-500/30 transition-colors duration-300 ${darkMode ? "bg-[#0a0a0a] text-gray-100" : "bg-white text-gray-900"}`}
      >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 text-center">
            {[
              ...
              <div key={i} className="group flex flex-col items-center">
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 transition-transform group-hover:scale-110 ${darkMode ? "bg-white/5" : "bg-white"}`}
                >
                  {step.icon}
                </div>
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 max-w-7xl mx-auto border-t border-black/5 dark:border-white/5">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-12 text-center">
            {[
              {
                icon: <UserCheck className="mx-auto mb-4 text-yellow-500" />,
                text: "Verified riders and vendors",
              },
              {
                icon: <ShieldCheck className="mx-auto mb-4 text-yellow-500" />,
                text: "Live GPS tracking & SOS",
              },
              {
                icon: <Lock className="mx-auto mb-4 text-yellow-500" />,
                text: "Secure encrypted payments",
              },
            ].map((item, i) => (
              <div key={i} className="group">
                {item.icon}
                <div className="font-bold text-xs sm:text-sm uppercase tracking-widest group-hover:text-yellow-500 transition-colors">
                  {item.text}
                </div>
              </div>
            ))}
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[9px] uppercase font-bold tracking-wider opacity-70 leading-none mb-0.5">
                    Download on the
                  </div>
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 max-w-3xl mx-auto border-t border-black/5 dark:border-white/5">
          ...
          <div className="space-y-3 sm:space-y-4">
            {FAQ_DATA.map((item, i) => (
              <div
                key={i}
                className={`border rounded-2xl overflow-hidden transition-all ${darkMode ? "bg-white/5 border-white/10" : "bg-white border-gray-200"}`}
              >
                <button
