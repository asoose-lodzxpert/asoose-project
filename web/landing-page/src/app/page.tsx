...
import { ArrowRight, Package, ShoppingBag, Truck, Car, Clock, Zap, TrendingUp, Shield, Moon, Sun } from 'lucide-react';
  ...
  return (
    <div className={isDark ? "min-h-screen bg-zinc-900 text-white" : "min-h-screen bg-zinc-50"}>
      ...
      <section className={`pt-32 pb-20 px-6 min-h-screen relative overflow-hidden ${isDark ? "bg-zinc-900" : "bg-zinc-50"}`}>
        <div className={`absolute inset-0 opacity-[0.03] ${isDark ? "opacity-[0.05]" : ""}`}>
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <pattern id="movement" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
              <path d="M0 50 Q 25 25, 50 50 T 100 50" stroke="currentColor" fill="none" strokeWidth="2"/>
              <path d="M50 0 Q 25 25, 0 50 T 0 100" stroke="currentColor" fill="none" strokeWidth="2"/>
            </pattern>
            <rect width="100%" height="100%" fill="url(#movement)" />
          </svg>
        </div>
          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-7 space-y-8">
              <div className="space-y-3">
                <h1 className={`text-[5.5rem] leading-[0.9] font-bold tracking-tighter ${isDark ? "text-white" : "text-zinc-900"}`}>
                  Coordination.<br/>
                  Scale.<br/>
                  <span className="text-orange-600">Seamless.</span>
                </h1>
                <p className={`text-xl font-light tracking-tight max-w-md pt-4 ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>
              ...
              <div className={`grid grid-cols-3 gap-6 pt-12 border-t ${isDark ? "border-zinc-700" : "border-zinc-200"}`}>
                <div>
                  <div className={`text-3xl font-bold ${isDark ? "text-white" : "text-zinc-900"}`}>99.9%</div>
                  <div className={`text-sm mt-1 ${isDark ? "text-zinc-400" : "text-zinc-600"}`}>Uptime SLA</div>
                </div>
                <div>
                  <div className={`text-3xl font-bold ${isDark ? "text-white" : "text-zinc-900"}`}>Sub-second</div>
                  <div className={`text-sm mt-1 ${isDark ? "text-zinc-400" : "text-zinc-600"}`}>Dispatch latency</div>
                </div>
                <div>
                  <div className={`text-3xl font-bold ${isDark ? "text-white" : "text-zinc-900"}`}>10K+</div>
      ...
      <section id="services" className={`py-20 px-6 ${isDark ? "bg-zinc-800" : "bg-white"}`}>
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className={`text-5xl font-bold tracking-tight mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Four systems.<br/>One platform.</h2>
            <p className={`text-lg ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Everything integrated and operating as a unified system.</p>
          </div>

          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-7 row-span-2 bg-orange-600 p-10 text-white relative overflow-hidden group cursor-pointer hover:bg-orange-700 transition-colors">
              <div className="absolute right-10 bottom-10 opacity-10">
                <ShoppingBag className="w-48 h-48" />
              </div>
              <div className="relative z-10">
                <ShoppingBag className="w-12 h-12 mb-6" />
                <h3 className="text-4xl font-bold mb-4">Food &amp; Groceries</h3>
                <p className="text-lg text-orange-50 mb-6 max-w-md">
            ...
            <div className="col-span-5 bg-zinc-900 p-8 text-white relative overflow-hidden group cursor-pointer hover:bg-zinc-800 transition-colors">
            ...
            <div className="col-span-5 bg-white border-2 border-zinc-900 p-8 relative overflow-hidden group cursor-pointer hover:bg-zinc-50 transition-colors">
              <div className="absolute right-6 top-6 opacity-5">
                <Car className="w-32 h-32" />
              </div>
              <div className="relative z-10">
                <Car className="w-10 h-10 mb-4 text-zinc-900" />
                <h3 className="text-2xl font-bold mb-3 text-zinc-900">Ride</h3>
            ...
            <div className={`col-span-12 p-8 border-l-8 border-orange-600 ${isDark ? "bg-zinc-700" : "bg-zinc-100"}`}>
      ...
      <section id="features" className={`py-20 px-6 ${isDark ? "bg-zinc-900" : "bg-zinc-50"}`}>
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className={`text-5xl font-bold tracking-tight mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Platform Capabilities</h2>
            <p className={`text-lg ${isDark ? "text-zinc-400" : "text-zinc-600"}`}>Enterprise infrastructure designed for operational excellence and real-time coordination.</p>
          </div>

          <div className="grid grid-cols-3 gap-6">
            <div className={`p-8 border-l-4 border-orange-600 ${isDark ? "bg-zinc-800" : "bg-white"}`}>
              <ShoppingBag className="w-10 h-10 text-orange-600 mb-4" />
              <h3 className={`text-2xl font-bold mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Customer Ecosystem</h3>
              <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Unified ordering, payment processing, and real-time tracking across food, groceries, and logistics.</p>
            </div>

            <div className={`p-8 border-l-4 border-orange-600 ${isDark ? "bg-zinc-800" : "bg-white"}`}>
              <Package className="w-10 h-10 text-orange-600 mb-4" />
              <h3 className={`text-2xl font-bold mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Vendor Management</h3>
              <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Store catalogs, menu management, order fulfillment, and performance analytics in one interface.</p>
            </div>

            <div className={`p-8 border-l-4 border-orange-600 ${isDark ? "bg-zinc-800" : "bg-white"}`}>
              <Truck className="w-10 h-10 text-orange-600 mb-4" />
              <h3 className={`text-2xl font-bold mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Rider Operations</h3>
              <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>GPS routing, earnings tracking, job dispatch, and performance metrics on demand.</p>
            </div>

            <div className={`p-8 border-l-4 border-orange-600 ${isDark ? "bg-zinc-800" : "bg-white"}`}>
              <Zap className="w-10 h-10 text-orange-600 mb-4" />
              <h3 className={`text-2xl font-bold mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Real-time Dispatch</h3>
              <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Sub-second job matching, intelligent routing, and dynamic resource allocation across all services.</p>
            </div>

            <div className={`p-8 border-l-4 border-orange-600 ${isDark ? "bg-zinc-800" : "bg-white"}`}>
              <Shield className="w-10 h-10 text-orange-600 mb-4" />
              <h3 className={`text-2xl font-bold mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Payment Infrastructure</h3>
              <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Secure transactions, multi-method support, settlement automation, and fraud prevention.</p>
            </div>

            <div className={`p-8 border-l-4 border-orange-600 ${isDark ? "bg-zinc-800" : "bg-white"}`}>
              <TrendingUp className="w-10 h-10 text-orange-600 mb-4" />
              <h3 className={`text-2xl font-bold mb-3 ${isDark ? "text-white" : "text-zinc-900"}`}>Admin Analytics</h3>
              <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>System monitoring, order analytics, performance dashboards, and operational insights.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <h2 className={`text-5xl font-bold tracking-tight mb-4 ${isDark ? "text-white" : "text-zinc-900"}`}>
                  Your business.<br/>
                  Your terms.<br/>
                  Our infrastructure.
                </h2>
                <p className={`text-lg ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className={`border-l-4 pl-4 ${isDark ? "border-orange-600" : "border-zinc-900"}`}>
                  <div className={`text-3xl font-bold mb-1 ${isDark ? "text-white" : "text-zinc-900"}`}>₦180K</div>
                  <div className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Avg. monthly earnings</div>
                  <div className={`text-xs mt-1 ${isDark ? "text-zinc-500" : "text-zinc-500"}`}>Active riders</div>
                </div>
                <div className="border-l-4 border-orange-600 pl-4">
                  <div className={`text-3xl font-bold mb-1 ${isDark ? "text-white" : "text-zinc-900"}`}>72hrs</div>
                  <div className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Avg. onboarding time</div>
                  <div className={`text-xs mt-1 ${isDark ? "text-zinc-500" : "text-zinc-500"}`}>From signup to first order</div>
                </div>
              </div>
            </div>

            <div className={`p-10 border-2 ${isDark ? "bg-zinc-900 border-orange-600" : "bg-zinc-50 border-zinc-900"}`}>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <TrendingUp className="w-6 h-6 text-orange-600 mt-1" />
                  <div>
                    <h3 className={`font-bold text-lg mb-1 ${isDark ? "text-white" : "text-zinc-900"}`}>Real-time dashboard</h3>
                    <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Track earnings, orders, and performance metrics as they happen.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Shield className="w-6 h-6 text-orange-600 mt-1" />
                  <div>
                    <h3 className={`font-bold text-lg mb-1 ${isDark ? "text-white" : "text-zinc-900"}`}>Insurance coverage</h3>
                    <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Every delivery and ride backed by comprehensive protection.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Clock className="w-6 h-6 text-orange-600 mt-1" />
                  <div>
                    <h3 className={`font-bold text-lg mb-1 ${isDark ? "text-white" : "text-zinc-900"}`}>Flexible scheduling</h3>
                    <p className={`text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>Work when you want. No minimum hours. No penalties.</p>
                  </div>
                </div>
      ...
      <footer className={isDark ? "bg-zinc-900 text-white py-16 px-6" : "bg-zinc-900 text-white py-16 px-6"}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="pt-8 border-t border-zinc-800 flex items-center justify-between text-sm text-zinc-500">
